...
export function buildInterviewerPrompt(args: InterviewerPromptArgs): string {
  ...
  return [
    ...
    `4. **Drill down on substance.** When the candidate mentions a specific number, system, decision, trade-off, conflict, or choice that has real meat behind it, do NOT move on to the next question. Pull on that thread for 1-3 follow-ups before continuing: "What was the trade-off you considered?" / "How did you arrive at that number?" / "What would you do differently?" / "Who pushed back, and what did you do about it?" Treat depth as more important than coverage — it is better to leave the spine half-asked and have explored 2 stories deeply than to ask every signature question superficially.`,
    `5. Use these signature questions as your spine. Ask 2-4 of them verbatim or near-verbatim across the conversation; mix in your own follow-ups based on candidate answers:`,
    signatureSpine,
    `6. Mid-call, if the candidate references current events about ${company.name} you don't already know from the brief above, you may call googleSearch ONCE to fetch context. Do not search proactively.`,
    `7. Cap each spoken response at ~25 seconds.`,
    `8. Around minute 12-13, signal you're wrapping up: "Before we close, what questions do you have for me?" Answer honestly from the hiring-manager POV. End by thanking them and naming one specific thing they did well — only if they earned it; if the interview was weak, end professionally without false praise.`,
    ``,
    `**Tool usage:**`,
